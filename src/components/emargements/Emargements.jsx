...
const Emargements = () => {
  ...
  const handleCardClick = (cardId, cardTitle, cardDay) => {
    ...
    setShowGroupesContent(true); // Affichage le contenu de la colonne "groupes" après avoir cliqué sur une carte

    const handleConfirmationClick = () => {
      setShowConfirmation(true);
      document.body.classList.add('modal-open');
      setShowGroupesContent(true); // Affichage le contenu de la colonne "groupes" après avoir cliqué sur "Valider la feuille d'émargement"
    };
